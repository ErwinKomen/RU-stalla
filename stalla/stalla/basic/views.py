...
class BasicDetails(DetailView):
    """Extension of the normal DetailView class for STALLA"""
        ...
        if self.checkAuthentication(request):
            ...
            if self.action == "":
                ...
                if self.dtype != "":
                    ...
                    sDbName = "stalla_{}_{}.{}".format(modelname, obj_id, extension)
                    sContentType = ""
                    if self.dtype == "csv":
                        ...
                        sDbName = "stalla_{}_{}.svg".format(modelname, obj_id)
                        ...
                        if len(arPart) > 1:
                            ...
                            # Set the filename correctly
                            sDbName = "stalla_{}_{}.png".format(modelname, obj_id)
